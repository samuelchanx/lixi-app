...
const databaseV2Json = [
  ...
  {
    "title": "月經流量",
    "question": "⁠月經最多的一天，妳會使用多少塊衛生巾？（以23cm日用衛生巾為標準）",
    "options": "<2,2-4,>4",
    "optionSeparator": "",
    "displayIndex": 1,
    "group": 1,
  ...
  {
    "question": "⁠妳會感到哪種痛楚？（可選多項）",
    "options": "月經不暢順,絞痛,長期隱隱痛,感覺冰凍,灼熱疼痛,有固定痛點,脹痛,有下墜感,腹部有包塊，但可推散,腰部疼痛",
    "optionSeparator": "",
    "group": 2,
    "optionAdditionalStep": "",
    "isMultipleChoice": "TRUE",
...
const colorAmountMatchData = [
  ...
  {"color": "lightDark", "月經過少": "腎氣虛", "月經過多": "腎氣虛", "正常": "腎氣虛"},
  {
    "color": "brightRed",
    "月經過少": "腎陰虛\n血熱(虛)",
    "月經過多": "血熱(實)",
