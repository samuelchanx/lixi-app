...
,,少,正常,多,淺,正常,鮮紅,深紅,紫紅,深紫,稀,正常,黏稠,有血塊,無,經前,經期間,經後,絞痛,長期隱隱痛,冷痛,灼痛,舒緩: 用暖東西敷肚,舒緩: 按壓會減少痛楚,加強: 按壓會更痛,舒緩: 血塊排出後疼痛減少,有固定痛點，如針刺狀,脹痛連及腹側,有下墜感,腹部有包塊，而此包塊推之可移，按之可散,月經來得不暢,量多,色透明,色黃或帶有血絲,質地稀,有臭味,陰部痕癢,陰部反覆感染,黯淡無光,臉頰通紅,偏黃,蒼白,青白,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
...
const databaseV2Json = [
  ...
  {
    "title": "經量",
    "question": "月經期最多的一天日用衛生巾（23cm）的使用量",
    "options": "<2,2-4,>4",
    "optionSeparator": "",
    "group": 1,
    "optionAdditionalStep": "",
  ...
  {
    "title": "經血顏色",
    "question": "請選擇最能描述您經期血液的所有顏色（可選多項）",
    "options":
        "(1)淡紅(#D0A19D)、(2)淡黯(#D0BEBE)、(8)正常(#CF424B)、(4)鮮紅(#E73024)、(5)深紅(#820100)、(6)深紫(#790033)、(7)紫紅(#3F010B)",
    "optionSeparator": "",
    "group": 1,
    "optionAdditionalStep": "colorParser",
    "isMultipleChoice": "TRUE",
    "expectedAnsFormat": "bloodColors",
    "isOptional": "",
    "logicReference":
        "月經過少\",\"月經過多\",\"正常\"\n\"淡紅\",\"脾陽不振(痰濕)\n肝虛血少(心脾兩虛)\n血寒（虛）\",\"脾氣虛弱\n氣虛\n血虛\"\n\"淡黯\",\"腎氣虛\",\"\"\n\"鮮紅\",\"腎陰虛\n血熱（虛）\",\"血熱（實）\"\n\"深紅\",\"肝氣鬱結\",\"肝氣鬱結\n血熱（實）\"\n\"紫紅\",\"肝鬱化火\n血瘀\n血寒（實）\",\"肝鬱化火\n血瘀\n血熱（實）\n濕熱蘊結\"\n\"深紫\",\"血瘀\n血寒（實）\",\"血瘀\"\n\"正常\",\"\",\"",
    "reference": "Step2",
  ...
  {
    "title": "經血質地",
    "question": "請選擇最能描述您經血的質地（可選多項）",
    "options": "稀,正常,黏稠,有血塊",
    "optionSeparator": "",
    "group": 1,
    "optionAdditionalStep": "",
    "isMultipleChoice": "TRUE",
    "expectedAnsFormat": "bloodTexture",
    "isOptional": "TRUE",
    "logicReference": "",
    "reference": "Step2",
  },
  {
    "question": "請在橫線上標示你的經痛程度",
    "title": "經痛",
    "options": "無痛,劇痛",
    "optionSeparator": "",
    "group": 2,
    "optionAdditionalStep": "",
    "isMultipleChoice": "",
    "expectedAnsFormat": "slider",
    "isOptional": "",
    "logicReference": "無（直接到（5））",
    "reference": "Step3,q1",
  },
  {
    "question": "經痛一般發生在什麼時候？(可選多項)",
    "options": "經前,經期間,經後",
...
const painImprovementData = [
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "T", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "T", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "T", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "T", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "T", "舒緩: 血塊排出後疼痛減少": "T"},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "T", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
  {"舒緩: 用暖東西敷肚": "T", "舒緩: 按壓會減少痛楚": "", "加強: 按壓會更痛": "", "舒緩: 血塊排出後疼痛減少": ""},
];

const colorAmountMatchData = [
  {
    "color": "lightRed",
    "月經過少": "脾陽不振(痰濕)\n肝虛血少(心脾兩虛)\n血虛\n血寒(虛)",
    "月經過多": "脾氣虛弱\n氣虛",
  ...
  {"color": "lightDark", "月經過少": "腎氣虛", "月經過多": "", "正常": "TBC"},
  {"color": "brightRed", "月經過少": "腎陰虛\n血熱(虛)", "月經過多": "血熱(實)", "正常": "TBC"},
  {"color": "deepRed", "月經過少": "肝氣鬱結", "月經過多": "肝氣鬱結\n血熱(實)", "正常": "TBC"},
  {
    "color": "purpleRed",
    "月經過少": "肝鬱化火\n血瘀\n血寒(實)",
    "月經過多": "肝鬱化火\n血瘀\n血熱(實)\n濕熱蘊結",
  ...
  {"color": "deepPurple", "月經過少": "血瘀\n血寒(實)", "月經過多": "血瘀", "正常": "TBC"},
  {"color": "normal", "月經過少": "TBC", "月經過多": "TBC", "正常": "TBC"},
];
